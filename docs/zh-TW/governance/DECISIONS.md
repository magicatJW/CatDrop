...
- 根目錄 `README.md`、RADS 與 `reports/` 維持繁體中文治理正本，避免破壞既有 context restore priority 與不可變歷史路徑。
- `docs/zh-TW/` 與 `docs/en/` 依 `governance`、`project`、`reports` 分類，對每一份正本 Markdown 提供繁中鏡像與英文對應版本。
