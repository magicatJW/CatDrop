...
- 日期：2026-07-20
- 階段：validation（雙語文件本機驗證完成，等待 GitHub CI）
...
- validation：19 對／57 份 Markdown、分類路徑、相對連結、嚴格 UTF-8 與英文 CJK 掃描 PASS；完整診斷 PASS；37/37 tests PASS；GitHub Actions 待推送後驗證，missing evidence is not PASS。
